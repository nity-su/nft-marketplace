    ...
    <div className="App">
      <div className="txbox">
        ...
        <div className="txcontents">
          <div
            className={`${state === 1 ? "txcontent txactive-content" : "txcontent "}`}
          >
            <TabContainer>
              <TxDetail></TxDetail>
            </TabContainer>
          ...
          <div
            className={`${state === 2 ? "txcontent txactive-content" : "txcontent "}`}
          >
            <TabContainer>
          ...
          <div
            className={`${state === 3 ? "txcontent txactive-content" : "txcontent "}`}
          >
            <TabContainer>
              <Util></Util>
            </TabContainer>
